    ...
    (function() {
      try {
          ...
          try {
            document.querySelector(".atomicat-component-container-cb82580 .atomicat-element-container a").addEventListener("click", () => {
              console.log("clicked button for event...");
              fbq('trackSingle', '400761069766578', 'AddToWishlist', {}, { eventID: getAtomiFbEventId() } )
